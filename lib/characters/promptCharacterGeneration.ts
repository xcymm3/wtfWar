...
职业范围：tank 攻击 5-15、生命 145-180；warrior 14-22、120-160；mage 13-23、95-130；assassin 16-25、105-145；ranger 20-30、85-120。主动技能的 cooldown 为 1-5（area_control 固定 5，invincible 为 3-5）；所有被动技能（type 以 _passive 结尾）的 cooldown 必须固定为 0。所有中文文本简洁，技能名不重复。`;
}
